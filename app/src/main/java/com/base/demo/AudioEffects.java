...
import com.base.download.util.Log;
...
class AudioEffects {
  ...
  public static boolean isAcousticEchoCancelerSupported() {
    ...
    // OS API call.
    return AudioUtils.runningOnJellyBeanOrHigher()
  ...
  public static boolean isAcousticEchoCancelerBlacklisted() {
    List<String> blackListedModels =
        AudioUtils.getBlackListedModelsForAecUsage();
  ...
  public static boolean isAutomaticGainControlBlacklisted() {
   List<String> blackListedModels =
        AudioUtils.getBlackListedModelsForAgcUsage();
    boolean isBlacklisted = blackListedModels.contains(Build.MODEL);
    if (isBlacklisted) {
  ...
  public static boolean isNoiseSuppressorBlacklisted() {
    List<String> blackListedModels =
        AudioUtils.getBlackListedModelsForNsUsage();
    boolean isBlacklisted = blackListedModels.contains(Build.MODEL);
    if (isBlacklisted) {
  ...
  public static boolean canUseAutomaticGainControl() {
    boolean canUseAutomaticGainControl =
        ...
        && !AudioUtils.useWebRtcBasedAutomaticGainControl()
  ...
  public static boolean canUseNoiseSuppressor() {
    boolean canUseNoiseSuppressor =
        ...
        && !AudioUtils.useWebRtcBasedNoiseSuppressor()
  ...
  public void enable(int audioSession) {
    ...
    // Add Log of supported effects but filter out "VoIP effects", i.e.,
    // AEC, AEC and NS.
